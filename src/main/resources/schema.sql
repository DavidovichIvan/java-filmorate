--норм создает и таблицы и индексы; как вариант если будут траблы с обновлением id в таблицах
-- = попробовать здесь вместо содания таблицы если она не существует сделать обратный маневр
--= удалить если она существует = DROP TABLE IF EXISTS films CASCADE - а потом создать заново; ну и файл data раскоментить тогда
